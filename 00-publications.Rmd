...
1. The exploration of the literature regarding current practices for visualising spatial data is presented in Chapter \ref{literature} has been submitted to the journal *Annals of Cancer Epidemiology* for publication.
...
2.  The algorithm is documented in Chapter \ref{algorithm} and will be submitted to the *Journal of Statistical Software*.
...
4.  The code for the algorithm documented in Chapter \ref{algorithm} is currently hosted on *CRAN* as the package sugarbag.
