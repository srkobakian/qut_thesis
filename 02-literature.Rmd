...
data.frame(
  stringsAsFactors = FALSE,
                ...
                `Data source` = c(
                       ...
                       "Map of cancer mortality rates in Spain.",
                       "The Pediatric Oncology Group of Ontario Networked Information System.")) %>%  
...
tibble::tribble( ~Feature, ~Choropleth, ~Contiguous , ~`Non-contig` , ~Dorling , ~`Tile maps` , ~Geofacets,
