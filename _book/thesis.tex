...
\addlinespace
4.6 & The distribution of the time taken (seconds) to submit a response for each combination of trend, whether the data plot was detected, and type of display, shown using horizontally jittered dotplots. & 77\\
...
\addcontentsline{toc}{section}{Cancer Applications of Choropleth Maps, and the Potential of Cartograms and Alternative Map Displays}
...
\addcontentsline{toc}{section}{Comparing the Effectiveness of the Choropleth Map with a Hexagon Tile Map for Communicating Cancer}
...
\addlinespace
1g & Atlas of Childhood Cancer in Ontario & the incidence rate of childhood cancers per 100,000 (by census division) for children aged 0-14, in Ontario from 1995 to 2004. & The Pediatric Oncology Group of Ontario Networked Information System.\\
\bottomrule
\end{tabular}
\end{table}
...
{\centering \includegraphics[width=1\linewidth]{thesis_files/figure-latex/detect-compare-1} 
...
{\centering \includegraphics[width=1\linewidth]{thesis_files/figure-latex/beeswarm-1} 
...
{\centering \includegraphics[width=1\linewidth]{thesis_files/figure-latex/certainty-1} 
