...
\hypertarget{sugarbag-package}{%
\section{\texorpdfstring{\texttt{sugarbag} package}{sugarbag package}}\label{sugarbag-package}}
...
Figure 3. displays the Australian areas with equally sized hexagons. This display allows the small and densely populated inner city areas to be easily contrasted with their neighbouring areas.
