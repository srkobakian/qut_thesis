...
\begin{tabular}{r>{\raggedright\arraybackslash}p{30em}rr}
\toprule
...
\begin{figure}
\includegraphics[width=1\linewidth]{thesis_files/figure-latex/detect-compare-1} \caption{The detection rates achieved by participants are contrasted when viewing the four replicates of the three trend models. Each point shows the probability of detection for the lineup display, the facets separate the trend models hidden in the lineup. The points for the same data set shown in a choroleth or hexagon tile map display are linked to show the difference in the detection rate.}\label{fig:detect-compare}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{thesis_files/figure-latex/pdetection-group-1} \caption{Boxplots of the distribution of detection rates for each line up, separated by group.}\label{fig:pdetection-group}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{thesis_files/figure-latex/pdetect-trend-1} \caption{Boxplots of the distribution of detection rates for each line up, separated by trend model.}\label{fig:pdetect-trend}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{thesis_files/figure-latex/pdetection-type-1} \caption{Boxplots of the distribution of detection rates for each line up, separated by type of display.}\label{fig:pdetection-type}
\end{figure}
