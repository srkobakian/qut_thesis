...
\tightlist
\item
  The algorithm is documented in Chapter \ref{ch:algorithm} and will be submitted to the \emph{Journal of Statistical Software}.
\end{enumerate}
...
\centering
\begin{tabular}[t]{l>{\raggedright\arraybackslash}p{7em}>{\raggedright\arraybackslash}p{10em}>{\raggedright\arraybackslash}p{10em}}
\toprule
