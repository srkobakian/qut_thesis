...
2.  The algorithm is documented in Chapter \ref{ch:algorithm} and will be submitted to the *Journal of Statistical Software*.
...
<!--chapter:end:00-publications.Rmd-->
...
data.frame(
  stringsAsFactors = FALSE,
                ...
                "relative risk for women developing lung cancer in England and Wales in 2010",
                       ...
                       "the relative incidence ratio of lung cancer in males in the state of QLD within Australia based on data from 1998 to 2007, Queensland Cancer Council",
                       "the percentage of Australian males between 50 - 54 years of age diagnosed with bowel cancer in 2016 in Australia.",
...
# Comparing the Effectiveness of the Choropleth Map with a Hexagon Tile Map for Communicating Cancer {#ch:experiment}
...
<!-- ```{r cities-hex12, results = "asis", fig.cap = "A hxagon tile map lineup, location 12 contains a distribution that affects all capital cities."} -->
<!-- ggdraw() + -->
...
<!-- ```{r cities-hex3, results = "asis", fig.cap = "A hxagon tile map lineup, location 3 contains a distribution that affects all capital cities."} -->
<!-- ggdraw() + -->
...
<!-- ```{r cities-hex4, results = "asis", fig.cap = "A hxagon tile map lineup, location 4 contains a distribution that affects all capital cities."} -->
<!-- ggdraw() + -->
...
<!-- ```{r cities-hex9, results = "asis", fig.cap = "A hxagon tile map lineup, location 9 contains a distribution that affects all capital cities."} -->
<!-- ggdraw() + -->
...
<!-- ```{r three-hex12, results = "asis", fig.cap = "A hxagon tile map lineup, location 12 contains a distribution that affects three of the Australian capital cities."} -->
<!-- ggdraw() + -->
...
<!-- ```{r three-hex5, results = "asis", fig.cap = "A hxagon tile map lineup, location 3 contains a distribution that affects three of the Australian capital cities."} -->
<!-- ggdraw() + -->
...
<!-- ```{r three-hex8, results = "asis", fig.cap = "A hxagon tile map lineup, location 4 contains a distribution that affects three of the Australian capital cities."} -->
<!-- ggdraw() + -->
...
<!-- ```{r three-hex9, results = "asis", fig.cap = "A hxagon tile map lineup, location 9 contains a distribution that affects three of the Australian capital cities."} -->
<!-- ggdraw() + -->
...
<!-- ```{r nwse-geo2, results = "asis", fig.cap = "A choropleth map lineup, location 12 contains a distribution that affects all capital nwse."} -->
<!-- ggdraw() + -->
...
<!-- ```{r nwse-hex2, results = "asis", fig.cap = "A hxagon tile map lineup, location 12 contains a distribution that affects all capital nwse."} -->
<!-- ggdraw() + -->
<!--   draw_plot(rasterGrob(readPNG("lineups/aus_nwse_2_geo.png"))) -->
<!-- ``` -->
\begin{figure}[H]
...
<!-- ```{r nwse-geo3, results = "asis", fig.cap = "A choropleth map lineup, location 3 contains a distribution that affects all capital nwse."} -->
<!-- ggdraw() + -->
...
<!-- ```{r nwse-hex3, results = "asis", fig.cap = "A hxagon tile map lineup, location 3 contains a distribution that affects all capital nwse."} -->
<!-- ggdraw() + -->
<!--   draw_plot(rasterGrob(readPNG("lineups/aus_nwse_3_geo.png"))) -->
<!-- ``` -->
\begin{figure}[H]
...
<!-- ```{r nwse-geo5, results = "asis", fig.cap = "A choropleth map lineup, location 4 contains a distribution that affects all capital nwse."} -->
<!-- ggdraw() + -->
...
<!-- ```{r nwse-hex5, results = "asis", fig.cap = "A hxagon tile map lineup, location 4 contains a distribution that affects all capital nwse."} -->
<!-- ggdraw() + -->
<!--   draw_plot(rasterGrob(readPNG("lineups/aus_nwse_5_geo.png"))) -->
<!-- ``` -->
\begin{figure}[H]
...
<!-- ```{r nwse-geo6, results = "asis", fig.cap = "A choropleth map lineup, location 9 contains a distribution that affects all capital nwse."} -->
<!-- ggdraw() + -->
...
<!-- ```{r nwse-hex6, results = "asis", fig.cap = "A hxagon tile map lineup, location 9 contains a distribution that affects all capital nwse."} -->
<!-- ggdraw() + -->
<!--   draw_plot(rasterGrob(readPNG("lineups/aus_nwse_6_geo.png"))) -->
<!-- ``` -->
\begin{figure}[H]
