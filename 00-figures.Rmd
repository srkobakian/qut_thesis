...
figs3 <- tibble::tibble(
  ...
  Page = c(44, 45, 47, 49, 50, 51, 52, 55, 56)
)
...
```{r fig2, echo = FALSE, warning = FALSE, results = "asis"}
 kable(figs2, format = "latex", booktabs = TRUE, escape = FALSE, align = "rrlr") %>% 
  kableExtra::column_spec(3, width = "15cm")
```


```{r fig3, echo = FALSE, warning = FALSE, results = "asis"}
 kable(figs3, format = "latex", booktabs = TRUE, escape = FALSE, align = "rrlr") %>% 
  kableExtra::column_spec(3, width = "15cm")
```


```{r fig4, echo = FALSE, warning = FALSE, results = "asis"}
 kable(figs4, format = "latex", booktabs = TRUE, escape = FALSE, align = "rrlr") %>% 
  kableExtra::column_spec(3, width = "15cm")
```
