...
The chapter frames the steps in light of the `sugarbag` [@sugarbag] package functions that allow users to enact the algorithm in `R` [@R]. It uses the Statistical Areas of Australia at Level 2, taking a subset and considering only those located within the island of Tasmania.
